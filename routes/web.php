...
Route::post('/marketing/upgrade', [MarketingController::class, 'upgradeFacility'])->name('marketing.upgrade');
Route::post('/marketing/reach', [MarketingController::class, 'reachCustomer'])->name('marketing.reach');
